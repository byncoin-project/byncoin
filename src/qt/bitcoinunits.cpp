...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BynCoins"));
    case mBTC: return QString(QObject::tr("Milli-BynCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BynCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
