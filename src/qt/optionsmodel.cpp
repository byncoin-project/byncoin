...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/byncoin/tx/%s|https://coinplorer.com/BYN/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/BYN/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/byncoin/tx/%s|https://coinplorer.com/BYN/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/BYN/tx/%s").toString();
